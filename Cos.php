    ...
    <div id="shopping-cart">
        <div class="txt-heading">
            ...
            <div class="txt-heading-label">Cos Cumparaturi</div> <a id="btnEmpty" href="cos.php?action=empty"><img
                    src="empty-cart.png" alt="empty-cart" title="Empty Cart" /></a>
        </div>
        <?php
...
center;"><strong>Action</strong></th>
                    ...
                    foreach ($cartItem as $item) {
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; border-bottom: #F0F0F0 1px solid;"><a href="cos.php?action=remove&id=<?php echo
                                $item["cart_id"]; ?>" 21 class="btnRemoveAction"><img src="icon-delete.png" alt="icon-delete"
                    ...
                    <tr>
                        ...
                        <td text-align=right><?php echo "$" . $item_total; ?></td>
                        <td></td>
                    </tr>
                </tbody>
            </table>
